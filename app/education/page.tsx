export default function Page() {
  return (
    <main className="container mx-auto px-4">
      <div className="">
        <h1 className="text-center text-2xl my-8">Education and Learning</h1>
        <div className="flex flex-wrap justify-center max-w-5xl mx-auto">
          {['Learning Methods', 'Educational Tools', 'Study Techniques', 'Curriculum Development', 'Educational Theories', 'Career Development'].map((tech, index) => (
            <div 
              key={tech}
              className={`
