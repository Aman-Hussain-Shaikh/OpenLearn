export default function Page() {
  return (
    <main className="container mx-auto px-4">
      <div className="">
        <h1 className="text-center text-2xl my-8">Law</h1>
        <div className="flex flex-wrap justify-center max-w-5xl mx-auto">
          {['Legal Basics', 'Business Law', 'Consumer Rights', 'Corporate Governance', 'Family and Estate Law', 'Criminal Law'].map((tech, index) => (
            <div 
              key={tech}
              className={`
