export default function Page() {
  return (
    <main className="container mx-auto px-4">
      <div className="">
        <h1 className="text-center text-2xl my-8">Lifestyle</h1>
        <div className="flex flex-wrap justify-center max-w-5xl mx-auto">
          {['Health and Wellness', 'Personal Development', 'Travel and Leisure', 'Home and Living', 'Fashion and Beauty', 'Hobbies and Interests'].map((tech, index) => (
            <div 
              key={tech}
              className={`
