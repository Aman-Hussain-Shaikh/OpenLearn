export default function Page() {
  return (
    <main className="container mx-auto px-4">
      <div className="">
        <h1 className="text-center text-2xl my-8">Marketing</h1>
        <div className="flex flex-wrap justify-center max-w-5xl mx-auto">
          {['Digital Marketing', 'Traditional Marketing', 'Market Research', 'Branding', 'Advertising', 'Analytics and Metrics'].map((tech, index) => (
            <div 
              key={tech}
              className={`
