export default function Page() {
  return (
    <main className="container mx-auto px-4">
      <div className="">
        <h1 className="text-center text-2xl my-8">Start-Up</h1>
        <div className="flex flex-wrap justify-center max-w-5xl mx-auto">
          {['Starting a Business', 'Business Models and Strategies', 'Growth and Scaling', 'Product Development', 'Marketing and Sales', 'Leadership and Management', 'Finance and Operations'].map((tech, index) => (
            <div 
              key={tech}
              className={`
